...
class FunctionBase:
    ...
    def chain_rule(cls, ctx, inputs, d_output):
        ...
        """
        # TODO: Implement for Task 1.3. Get dout, passes it to the right function's backwards, then it returns
        # Calls backwards, loops throught the inputs and throws away all the derivatives of the inputs that are
        # constant
